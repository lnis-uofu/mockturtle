...
TEST_CASE( "Window resubstitution of MIG using mig_resyn_bottom_up", "[resubstitution]" )
{
  using namespace mockturtle::experimental;
  ...
  mig_resyn_bottom_up resyn;
  window_resubstitution( fmig, resyn );
}

TEST_CASE( "Window resubstitution of MIG using akers_resyn", "[resubstitution]" )
{
  using namespace mockturtle::experimental;
